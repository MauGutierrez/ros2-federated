...
from ros2_rl_agents_2.unity_env import UnityEnv
from ros2_rl_agents_2.unity_agent import UnityAgent
from ros2_rl_agents_2.metrics import MetricLogger
...
def main():
    ...
    settings_path = os.path.join(get_package_share_directory('ros2_rl_agents_2'), 'config/settings.json')
